...
################################################################
# This is a generated script based on design: zc706
#
...
proc create_root_design { parentCell } {
  ...
  set gpio_sws_3bits [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 gpio_sws_3bits ]
  ...
  # Create instance: gpio_sws_3bits, and set properties
  set gpio_sws_3bits [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 gpio_sws_3bits ]
  set_property -dict [ list \
   CONFIG.GPIO_BOARD_INTERFACE {gpio_sws_3bits} \
   CONFIG.USE_BOARD_FLOW {true} \
 ] $gpio_sws_3bits

  # Create instance: led_4bits, and set properties
  set led_4bits [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 led_4bits ]
  set_property -dict [ list \
  ...
  connect_bd_intf_net -intf_net dip_switches_4bits_GPIO [get_bd_intf_ports dip_switches_4bits] [get_bd_intf_pins dip_switches_4bits/GPIO]
  connect_bd_intf_net -intf_net gpio_sws_3bits_GPIO [get_bd_intf_ports gpio_sws_3bits] [get_bd_intf_pins gpio_sws_3bits/GPIO]
  connect_bd_intf_net -intf_net led_4bits_GPIO [get_bd_intf_ports led_4bits] [get_bd_intf_pins led_4bits/GPIO]
  ...
  connect_bd_intf_net -intf_net ps7_1_axi_periph_M00_AXI [get_bd_intf_pins dip_switches_4bits/S_AXI] [get_bd_intf_pins ps7_1_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net ps7_1_axi_periph_M01_AXI [get_bd_intf_pins gpio_sws_3bits/S_AXI] [get_bd_intf_pins ps7_1_axi_periph/M01_AXI]
  connect_bd_intf_net -intf_net ps7_1_axi_periph_M02_AXI [get_bd_intf_pins led_4bits/S_AXI] [get_bd_intf_pins ps7_1_axi_periph/M02_AXI]

  # Create port connections
  connect_bd_net -net processing_system7_1_FCLK_CLK0 [get_bd_pins dip_switches_4bits/s_axi_aclk] [get_bd_pins gpio_sws_3bits/s_axi_aclk] [get_bd_pins led_4bits/s_axi_aclk] [get_bd_pins processing_system7_1/FCLK_CLK0] [get_bd_pins processing_system7_1/M_AXI_GP0_ACLK] [get_bd_pins ps7_1_axi_periph/ACLK] [get_bd_pins ps7_1_axi_periph/M00_ACLK] [get_bd_pins ps7_1_axi_periph/M01_ACLK] [get_bd_pins ps7_1_axi_periph/M02_ACLK] [get_bd_pins ps7_1_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_1_50M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_ps7_1_50M_peripheral_aresetn [get_bd_pins dip_switches_4bits/s_axi_aresetn] [get_bd_pins gpio_sws_3bits/s_axi_aresetn] [get_bd_pins led_4bits/s_axi_aresetn] [get_bd_pins ps7_1_axi_periph/ARESETN] [get_bd_pins ps7_1_axi_periph/M00_ARESETN] [get_bd_pins ps7_1_axi_periph/M01_ARESETN] [get_bd_pins ps7_1_axi_periph/M02_ARESETN] [get_bd_pins ps7_1_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_1_50M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x41200000 [get_bd_addr_spaces processing_system7_1/Data] [get_bd_addr_segs dip_switches_4bits/S_AXI/Reg] SEG_dip_switches_4bits_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x41210000 [get_bd_addr_spaces processing_system7_1/Data] [get_bd_addr_segs gpio_sws_3bits/S_AXI/Reg] SEG_gpio_sws_3bits_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x41220000 [get_bd_addr_spaces processing_system7_1/Data] [get_bd_addr_segs led_4bits/S_AXI/Reg] SEG_led_4bits_Reg
